...
DO $$
    ...
    BEGIN
		ALTER TABLE ptemp.rl DROP COLUMN IF EXISTS rl_area;
		ALTER TABLE ptemp.rl DROP COLUMN IF EXISTS rl_deficit_area;
		ALTER TABLE ptemp.rl DROP COLUMN IF EXISTS rl_deficit_geom;
		
		ALTER TABLE ptemp.rl ADD COLUMN IF NOT EXISTS rl_area double precision;
		ALTER TABLE ptemp.rl ADD COLUMN IF NOT EXISTS rl_deficit_area double precision;
		ALTER TABLE ptemp.rl ADD COLUMN IF NOT EXISTS rl_deficit_geom geometry(Geometry,4674);
