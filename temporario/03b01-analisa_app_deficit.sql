...
DO $$
    ...
    BEGIN
		ALTER TABLE ptemp.app DROP COLUMN IF EXISTS app_area;
		ALTER TABLE ptemp.app DROP COLUMN IF EXISTS app_deficit_area;
		ALTER TABLE ptemp.app DROP COLUMN IF EXISTS app_deficit_geom;
		
		ALTER TABLE ptemp.app ADD COLUMN IF NOT EXISTS app_area double precision;
		ALTER TABLE ptemp.app ADD COLUMN IF NOT EXISTS app_deficit_area double precision;
		ALTER TABLE ptemp.app ADD COLUMN IF NOT EXISTS app_deficit_geom geometry(Geometry,4674);
